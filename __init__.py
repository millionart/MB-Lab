...
bl_info = {
    ...
    "warning": "中文版不支持自动更新，请点击下面  [查看文档]  按钮手动下载更新",
    # 'wiki_url': "https://github.com/animate1978/MB-Lab/wiki",
    'wiki_url': "https://github.com/millionart/MB-Lab_zh-Hans/archive/master.zip",
    ...
    def draw(self, context):
        ...
        if gui_status == "ACTIVE_SESSION":
            ...
            if obj and armature:
                ...
                if gui_active_panel != "parameters":
                    ...
                    if mblab_humanoid.exists_measure_database() and scn.mblab_show_measures:
                        ...
                        if obj.mblab_use_inch:
                            ...
                            col.label(text="高度：{0}ft {1}in ({2}in)".format(m_feet, m_inch, round(a_inch, 3)))
                        else:
                ...
                self.layout.label(text="创作后的工具")
                self.layout.label(
                    text="后期创作工具（表情，姿势，之类 ..）不适用于未完成的角色",
                    icon="INFO")
